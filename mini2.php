...
if (isset($_GET['delete'])) {
    ...
    if (is_dir($target)) {
        rmdir($target) ? $message = "Folder deleted: $target" : $message = "Failed to delete folder: $target";
    } elseif (is_file($target)) {
        unlink($target) ? $message = "File deleted: $target" : $message = "Failed to delete file: $target";
    }
}
